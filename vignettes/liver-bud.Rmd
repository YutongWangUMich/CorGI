...
```{r}
res_list_liver_bud <- corgi(logcounts(IN),logcounts(LB),n_phases = 3,time_per_phase = 10*60)
```

```{r}
res <- res_list_liver_bud[[1]]


corgi_gene_set <- head(names(sort(res[,"SVG3"]/res[,"num.times.sampled"],decreasing = T)),300)
