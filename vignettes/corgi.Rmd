...
```{r, eval = F}
corgi_output_embyro_devel <- run_corgi(X,Y,time_per_phase = 10*60)
devtools::use_data(corgi_output_embyro_devel)
```
...
corgi_gene_set <- select_top_corgi_genes(corgi_output_embyro_devel,n = 300,SVG_use = 3)
